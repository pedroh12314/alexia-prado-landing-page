          ...
          <div class="pt-1 pb-6 px-5">
            <div class="mt-6">
              <nav class="grid gap-y-8">
                ...
                <a
                  href="/blog"
                  class="flex items-center rounded-xl text-gray-900 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"
                >
                  <svg
                    class="h-6 flex-shrink-0 text-purple-500"
                    xmlns="http://www.w3.org/2000/svg"
...
<svg
    ...
    <!-- Start: Footer -->
    <footer>
      <div class="pt-6 md:pt-12 bg-purple-600 text-white">
        <div class="container px-5 mx-auto sm:px-10">
          <div class="md:flex md:flex-wrap md:-mx-4 py-6 md:pb-12">
            <!-- Start: First Block -->
            <div class="lg:w-1/3 md:px-4 justify-center text-center mt-0">
              <h1 class="font-bold">MAPA DO SITE</h1>
              <div class="sm:flex-1 text-center mt-4">
                <g-link to="/" class="text-white hover:text-gray-400 py-1 block"
                  >Home</g-link
                >
                                <!-- <a
                  href="#"
                  class="text-white hover:text-gray-400 py-1 block"
                  >Currículo</a
                >
                <a
                  href="#"
