<template>
  <Layout class="leading-normal tracking-normal text-white gradient">
    <!--Hero-->
    <div>
      <div
      ...
      >
        ...
        >
          <!-- <p class="mt-12 uppercase tracking-loose w-full">Que tipo de negócio você tem?</p> -->
          <h1 class="my-4 text-4xl font-bold leading-tight">
            Como você pode
            <br />
            <vue-typer
              :text="[
                'trabalhar menos e vender mais?',
                'ter mais reconhecimento?',
                'metrificar seus resultados',
              ]"
              :repeat="Infinity"
              :shuffle="false"
          ...
          <p class="leading-normal text-2xl mb-8">
            Tenha redes sociais atualizadas com boas estratégias para receber
            seu publico com mais conforto e confiança
          </p>
          <button
            v-scroll-to="'#marketing'"
            style="background-color: #ffff; text-decoration: none"
            class="mx-auto lg:mx-0 hover:underline text-gray-800 font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-300 ease-in-out"
          >
    ...
    <section id="marketing" class="bg-white border-b py-8">
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="w-full mb-4">
          <div
            class="h-1 mx-auto gradient w-64 opacity-50 my-0 py-0 rounded-t"
          ></div>
        </div>
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            ...
            <p class="text-gray-600 mb-8">
              A presença online ajuda no reconhecimento da marca e em sua
              divulgação. Quanto mais próximo você estiver de seus clientes
              melhor. Para isso, é importante manter as redes sociais sempre
              atualizadas, com postagens de qualidade e constantes.
            </p>
          </div>
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              ...
              <p class="text-gray-600 mb-8">
                A maior vantagem das redes sociais modernas está em
                disponibilizar aos profissionais de marketing uma complexa
                ferramenta de anúncios para que nós possamos ter diversas formas
                de vender um produto. Assim, é possível criar um anúcio que
                chegue diretamente na pessoa que está disposta a comprar, uma
                vez que essas redes sabem exatamente qual pessoa será mais
                suscetível ao anúcio através de seus comportamentos.
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="bg-white border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
          <div
            class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-2xl"
          >
          ...
          <div
            class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow-2xl p-6"
          >
            <div class="flex items-center justify-center">
              <button
                class="mx-auto lg:mx-0 gradient text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-100 ease-in-out"
              >
                Action
              </button>
            </div>
    ...
    <section class="bg-gray-100 py-8">
      <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
        ...
        <div
          class="flex flex-col sm:flex-row justify-center pt-12 my-12 mx-0 sm:my-4"
        >
          <div
            class="transition duration-500 hover:shadow-xl transform hover:-translate-y-12 flex flex-col w-5/6 lg:w-1/4 mx-auto lg:mx-0 rounded-none lg:rounded-l-lg bg-white mt-4"
          >
            <div
            ...
            >
              ...
              <ul class="w-full text-center text-sm">
                <li class="border-b py-4">18 Artes</li>
                <li class="border-b py-4">Personalização completa</li>
                <li class="border-b py-4">Escolha o conteúdo</li>
                <li class="border-b py-4">
                  Paleta de cores de sua preferência
                </li>
              </ul>
            </div>
            <div
            ...
            >
              ...
              >
                <!-- algum titulo -->
                <span class="text-base">Valor a combinar</span>
              </div>
              <div class="flex items-center justify-center">
                <button
                  class="mx-auto lg:mx-0 color-primary text-white font-bold rounded-full my-6 py-4 px-8 shadow-lg focus:outline-none focus:shadow-outline transform transition hover:scale-105 duration-100 ease-in-out"
                >
                  Saber mais
                </button>
              </div>
          ...
          <div
            class="transition duration-500 hover:shadow-xl transform hover:-translate-y-24 flex flex-col w-5/6 lg:w-1/4 ml-4 mr-2 lg:ml-4 lg:mr-2 rounded-none lg:rounded-l-lg bg-white mt-4"
          >
            <div
            ...
            >
              ...
              <ul class="w-full text-center text-base font-bold">
                <li class="border-b py-4">12 Postagens no story</li>
                <li class="border-b py-4">12 Postagens no feed</li>
                <li class="border-b py-4">Criação de destaques</li>
                <li class="border-b py-4">12 textos criativos</li>
              </ul>
            </div>
            <div
              class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6"
          ...
          <div
            class="transition duration-500 hover:shadow-xl transform hover:-translate-y-24 flex flex-col ml-2 mr-4 w-5/6 lg:w-1/4 mx-auto lg:ml-2 lg:mr-4 rounded-none lg:rounded-l-lg bg-white mt-4"
          >
            <div
              class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow"
            >
              <div class="w-full p-4 text-3xl font-bold text-center">
                Anúncio em redes sociais (Mensal)
              </div>
              <div class="h-1 w-full color-primary my-0 py-0 rounded-t"></div>
              <ul class="w-full text-center text-base font-bold">
                <li class="border-b py-4">4 Anúncios</li>
                <li class="border-b py-4">Análise de resultados</li>
                <li class="border-b py-4">
                  Direcionado ao publico do seu negócio
                </li>
              </ul>
            </div>
            <div
              class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6"
            >
              <div class="w-full pt-0 text-4xl font-bold text-center">
                <span class="text-base">Valor a combinar</span>
              </div>
              <div class="flex items-center justify-center">
                <button
          ...
          >
            <div
              class="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow"
            >
              <div class="p-5 text-3xl font-bold text-center border-b-4">
                Identidade visual (Avulso)
              </div>
              <ul class="w-full text-center text-sm">
                <li class="border-b py-4">Logo principal</li>
                <li class="border-b py-4">Sub-marca</li>
                <li class="border-b py-4">Paleta de cores</li>
                <li class="border-b py-4">4 destaques de brinde</li>
              </ul>
            </div>
            <div
              class="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6"
            >
              <div
                class="w-full pt-0 text-3xl text-gray-600 font-bold text-center"
              >
                <!-- £x.99 -->
                <span class="text-base">Valor a combinar</span>
              </div>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
      ...
      <h3 class="my-7 text-3xl leading-tight">
        Me mande uma mensagem para que possamos conversar mais sobre seu
        negócio.
      </h3>
      <button
        type="submit"
        ...
        class="ite ms-center inline-flex justify-center px-5 py-5 mt-7 rounded-2xl focus:outline-none text-purple-500 bg-white transition duration-500 ease-in-out hover:shadow-xl transform hover:-translate-y-1"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-6 mr-5"
...
export default {
  ...
  methods: {
    openWhatsapp() {
      window.open(
        "https://api.whatsapp.com/send?phone=5512997195967&text=Ol%C3%A1%20Al%C3%A9xia.%20Eu%20gostaria%20de%20conhecer%20mais%20sobre%20seu%20trabalho."
      );
    },
  },
};
